 ...
 */
@Autonomous(name = "Autonomous runtime function")
public class AutonomousJewelGripperTurnBackToCryptoBoxWithVuforiaRed123readjewelswithruntimeresetfunction extends LinearOpMode {
...
//if red knock off blue
    ...
    public void encoderDrive(double speed,
                             int leftInches, double rightInches,
                             double timeoutS) {
        int newLeftTarget;
        int newRightTarget;
